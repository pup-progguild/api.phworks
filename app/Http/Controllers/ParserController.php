...
{
    public function removePrepositions($description) 
    {
        $prepositions = [ 
    ...
    public function removeHelpingVerb($description) 
    {
        $helpingVerbs = [
    ...
    public function removePronouns($description)
    {
        $pronouns = [ 
    ...
    public function removeDeterminers($description)
    {
        $determiners = [ 
